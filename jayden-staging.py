...
time.sleep(3)
motor.run_for_degrees(port.F, 130, 200)
time.sleep(3)
while not distance_sensor.distance(port.C) >= 100:
    while distance_sensor.distance(port.C)<= 100:
        motor.run_for_degrees(port.F, 3, 200)
        time.sleep(0.01)
distance = distance_sensor.distance(port.C)
motor.run_for_degrees(port.D, distance, 200)
motor.run_for_degrees(port.F, -distance, 200)
time.sleep(2)
motor.run_for_degrees(port.E, 200, 350)
